...
public class Messages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getReferences();
        mMessageAdapter = new MessageListAdapter(Messages.this, messages,currentUserId);
        mMessageRecycler.setAdapter(mMessageAdapter);
        mMessageRecycler.setLayoutManager(new LinearLayoutManager(Messages.this));
        loadMessages();
                ...
                call.enqueue(new Callback<Message>() {
                    ...
                    public void onResponse(Call<Message> call, Response<Message> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(Messages.this, response.code() + "", Toast.LENGTH_SHORT).show();
                        }
                    }

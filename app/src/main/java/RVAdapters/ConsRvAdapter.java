...
public class ConsRvAdapter
        extends RecyclerView.Adapter<ConsRvAdapter.RvHolder> {
    private final List<Conversation> conversations;
    private LayoutInflater layoutInflater;
    private Context context;

    public ConsRvAdapter(List<Conversation> conversations, Context context) {
    ...
    @NonNull
    @Override
    public ConsRvAdapter.RvHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = layoutInflater.inflate(R.layout.one_conversation, viewGroup, false);
        return new RvHolder(itemView, this);
    }

    @Override
    public void onBindViewHolder(@NonNull ConsRvAdapter.RvHolder rvHolder, final int i) {
    ...
    public class RvHolder
        ...
        final ConsRvAdapter adapter;
        public final TextView name;
        int conId = 0;

        public RvHolder(@NonNull View itemView, final ConsRvAdapter adapter) {
            super(itemView);
